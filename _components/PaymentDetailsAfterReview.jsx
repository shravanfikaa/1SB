...
function PaymentDetails({ details }) {
  const { productLogoURL, paymentDetails, disclaimerText } = details;
  ...
  return (
    <div className="flex flex-col w-4/5">
        ...
        <div className="border-solid border-2 border-gary-600 w-auto p-4">
          <div className="flex flex-row gap-x-3">
            ...
            <div className="flex flex-col">
              <span className="text-5xl text-regular text-black">
            ...
            <div className="flex gap-x-3 text-base">
              ...
              <div className="w-1/2 text-left">
                ...
                <div className="text-regular text-fd-primary capitalize">
                  <p className="break-all text-black">{paymentDetails.status}</p>
                </div>
                {
                  paymentDetails?.manufacturer_id?.toLowerCase() === "usfb" ?
                    <>
                      ...
                      <div className="text-regular capitalize">
                        <p className="break-all text-black">{paymentDetails?.interest_rate} %</p>
                      </div>
                    </>
                    : null
                }
      ...
      <div className="gap-3">
        {disclaimerText && paymentDetails?.manufacturer_id?.toLowerCase() !== "usfb" ? (
          <span className={`text-base text-light-gray text-regular`}>
            Disclaimer:{" "}
            {disclaimerText.replace(
              "<FDIssuerName>",
              paymentDetails.manufacturer_id
            )}
          </span>
        ) : null}
      </div>
