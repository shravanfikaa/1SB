    ...
    <>
      <div className="fixed inset-0 z-10 overflow-y-auto">
        ...
        <div className="flex justify-center items-center min-h-screen ">
          ...
          >
            <div className="flex justify-start text-medium text-black text-center text-4xl mb-5">
            ...
            {historyData.length ? (
              <div className="flex flex-col break-all text-regular text-2xl text-center max-h-80 overflow-y-scroll">
                <div className="flex justify-between text-left text-light-gray gap-3">
                  ...
                  <div className="w-1/6 break-normal">{translate(ADDRESS_DETAILS.city)}</div>
